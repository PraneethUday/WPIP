...
const IconClaims = () => (
  <svg width="16" height="16" fill="none" viewBox="0 0 16 16">
    ...
    <path d="M12 5h1.5a.5.5 0 0 1 .5.5v9a.5.5 0 0 1-.5.5H5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
  </svg>
);
...
const IconSupport = () => (
  <svg width="16" height="16" fill="none" viewBox="0 0 16 16">
    ...
    <path d="M8 12v-1" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
    <path d="M8 10c0-2 3-2.5 3-4.5a3 3 0 0 0-6 0" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
  </svg>
);

const IconDisruptions = () => (
  <svg width="16" height="16" fill="none" viewBox="0 0 16 16">
    <path d="M8 2L2 13h12L8 2z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
...
const IconAnalytics = () => (
  <svg width="16" height="16" fill="none" viewBox="0 0 16 16">
    <path d="M2 13V8M6 13V5M10 13V3M14 13V7" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
  </svg>
);
...
const NAV_MAIN: NavItem[] = [
  ...
  { href: "/control-center", label: "Control Center", icon: <IconControlCenter /> },
];
