...
const translations = {
  en: {
    ...
    no_claims:
      "No claims yet. Claims appear automatically when a disruption is detected.",
  ...
  hi: {
    ...
    all: "सभी",
    auto_claim_note:
      "दावे स्वचालित रूप से होते हैं — मैन्युअल फ़ाइलिंग की जरूरत नहीं",
  ...
  te: {
    ...
    no_claims:
      "ఇంకా క్లెయిమ్‌లు లేవు. సంఘటన జరిగినప్పుడు స్వయంచాలకంగా కనిపిస్తాయి.",
    ...
    no_claims_empty:
      "కవరేజ్ ట్రిగర్ అయినప్పుడు మీ క్లెయిమ్‌లు ఇక్కడ కనిపిస్తాయి.",
  ...
  ta: {
    ...
    under_review_note:
      "மதிப்பாய்வில் உள்ளது — பொதுவாக 24 மணி நேரத்தில் தீர்க்கப்படும்",
  ...
  ml: {
    ...
    demo_note:
      "ഇത് ഒരു ഡെമോ പേയ്‌മെന്റ് ആണ് — യഥാർഥ ഇടപാട് ഒന്നും നടക്കുന്നില്ല.",
